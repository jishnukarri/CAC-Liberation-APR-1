...
KPLIB_intelBuildingClasses = [
    ...
    "Land_AGS_bldgs1", 
    "Land_AGS_bldgs2",
    "land_pmc_opx_apartmentcomplex", 
    "land_pmc_opx_apartmentcomplex4", 
    "land_pmc_opx_apartmentcomplex5", 
    "land_pmc_opx_apartmentcomplex_wip", 
    "land_pmc_opx_big", 
    "land_pmc_opx_big_b", 
    "land_pmc_opx_big_d", 
    "land_pmc_opx_big_e", 
    "land_pmc_opx_big_f", 
    "land_pmc_opx_block1", 
    "land_pmc_opx_complex1", 
    "land_pmc_opx_complex2", 
    "land_pmc_opx_complex3", 
    "land_pmc_opx_complex4", 
    "land_pmc_opx_complex5", 
    "land_pmc_opx_complex6", 
    "land_pmc_opx_complex7", 
    "land_pmc_opx_complex9", 
    "land_pmc_opx_garage1", 
    "land_pmc_opx_house_big1", 
    "land_pmc_opx_long1", 
    "land_pmc_opx_parkinghouse", 
    "land_pmc_opx_corner1", 
    "land_pmc_opx_corner2", 
    "land_pmc_opx_h01", 
    "land_pmc_opx_cornershop1", 
    "land_pmc_opx_h19", 
    "land_pmc_opx_h16", 
    "land_pmc_opx_h11_b", 
    "land_pmc_opx_hut1", 
